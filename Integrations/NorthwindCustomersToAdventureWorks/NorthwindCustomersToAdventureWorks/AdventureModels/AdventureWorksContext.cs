...
public partial class AdventureWorksContext : DbContext
{
    ...
    public virtual DbSet<VEmployeePersonTemporalInfo> VEmployeePersonTemporalInfos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=AdventureWorks;Trusted_Connection=True;Encrypt=no;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DemoSalesOrderDetailSeed>(entity =>
        {
            ...
            entity
                .ToTable("DemoSalesOrderDetailSeed", "Demo")
                .IsMemoryOptimized();
        ...
        modelBuilder.Entity<DemoSalesOrderHeaderSeed>(entity =>
        {
            ...
            entity
                .ToTable("DemoSalesOrderHeaderSeed", "Demo")
                .IsMemoryOptimized();
        ...
        {
            entity.HasKey(e => e.BusinessEntityId).HasName("PK_Employee_History_BusinessEntityID");

            entity
                .ToTable("Employee_Temporal", "HumanResources")
                .ToTable(tb => tb.IsTemporal(ttb =>
                    {
                        ttb.UseHistoryTable("Employee_Temporal_History", "HumanResources");
                        ttb
        ...
        {
            entity.ToTable("OrderTracking", "Sales", tb => tb.HasComment("Individual tracking events associated with a specific sales order."));

            entity.HasIndex(e => e.CarrierTrackingNumber, "IX_OrderTracking_CarrierTrackingNumber");

            entity.HasIndex(e => e.SalesOrderId, "IX_OrderTracking_SalesOrderID");
        ...
        {
            entity.HasKey(e => e.PersonId).HasName("PK_Person_json_PersonID");
        ...
        {
            entity.HasKey(e => e.BusinessEntityId).HasName("PK_Person_Temporal_BusinessEntityID");

            entity
                .ToTable("Person_Temporal", "Person")
                .ToTable(tb => tb.IsTemporal(ttb =>
                    {
                        ttb.UseHistoryTable("Person_Temporal_History", "Person");
                        ttb
                            .HasPeriodStart("ValidFrom")
                            .HasColumnName("ValidFrom");
                        ttb
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("IMPK_Product_ProductID");

            entity
                .ToTable("Product_inmem", "Production")
                .IsMemoryOptimized();

            entity.HasIndex(e => e.Name, "IX_Name");

            entity.HasIndex(e => e.ProductNumber, "IX_ProductNumber");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("ODPK_Product_ProductID");
        ...
        {
            entity.HasKey(e => new { e.SalesOrderId, e.SalesOrderDetailId }).HasName("imPK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID");

            entity
                .ToTable("SalesOrderDetail_inmem", "Sales")
                .IsMemoryOptimized();
            ...
            entity.HasOne(d => d.SalesOrder).WithMany(p => p.SalesOrderDetailInmems)
                .HasForeignKey(d => d.SalesOrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("IMFK_SalesOrderDetail_SalesOrderHeader_SalesOrderID");

            entity.HasOne(d => d.SpecialOfferProductInmem).WithMany(p => p.SalesOrderDetailInmems)
                .HasForeignKey(d => new { d.SpecialOfferId, d.ProductId })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.SalesOrderId, e.SalesOrderDetailId }).HasName("ODPK_SalesOrderDetail_SalesOrderID_SalesOrderDetailID");
            ...
            entity.HasOne(d => d.SalesOrder).WithMany(p => p.SalesOrderDetailOndisks)
                .HasForeignKey(d => d.SalesOrderId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ODFK_SalesOrderDetail_SalesOrderHeader_SalesOrderID");

            entity.HasOne(d => d.SpecialOfferProductOndisk).WithMany(p => p.SalesOrderDetailOndisks)
                .HasForeignKey(d => new { d.SpecialOfferId, d.ProductId })
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.SalesOrderId).HasName("PK__SalesOrd__B14003C3270C320B");

            entity
                .ToTable("SalesOrderHeader_inmem", "Sales")
                .IsMemoryOptimized();

            entity.HasIndex(e => e.CustomerId, "IX_CustomerID");

            entity.HasIndex(e => e.SalesPersonId, "IX_SalesPersonID");
        ...
        {
            entity.HasKey(e => e.SalesOrderId).HasName("PK__SalesOrd__B14003C2B181FB70");
        ...
        {
            entity.HasKey(e => e.SalesOrderId).HasName("PK_SalesOrder__json_SalesOrderID");
        ...
        {
            entity.HasKey(e => e.SpecialOfferId).HasName("IMPK_SpecialOffer_SpecialOfferID");

            entity
                .ToTable("SpecialOffer_inmem", "Sales")
                .IsMemoryOptimized();
        ...
        {
            entity.HasKey(e => e.SpecialOfferId).HasName("ODPK_SpecialOffer_SpecialOfferID");
        ...
        modelBuilder.Entity<SpecialOfferProductInmem>(entity =>
        {
            ...
            entity
                .ToTable("SpecialOfferProduct_inmem", "Sales")
                .IsMemoryOptimized();
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.SpecialOfferProductInmems)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("IMFK_SpecialOfferProduct_Product_ProductID");

            entity.HasOne(d => d.SpecialOffer).WithMany(p => p.SpecialOfferProductInmems)
                .HasForeignKey(d => d.SpecialOfferId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SpecialOfferProductOndisk>(entity =>
        {
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.SpecialOfferProductOndisks)
                .HasForeignKey(d => d.ProductId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("ODFK_SpecialOfferProduct_Product_ProductID");

            entity.HasOne(d => d.SpecialOffer).WithMany(p => p.SpecialOfferProductOndisks)
                .HasForeignKey(d => d.SpecialOfferId)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.TrackingEventId).HasName("PK_TrackingEvent_TrackingEventID");

            entity.ToTable("TrackingEvent", "Sales", tb => tb.HasComment("Tracking event lookup table."));
        ...
        modelBuilder.Entity<VEmployeePersonTemporalInfo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vEmployeePersonTemporalInfo", "HumanResources");
